...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        double magn = eq.getMag();
        magnitude.setText(d.format(magn));
        ...
        TextView offset = (TextView)listItemView.findViewById(R.id.loc_offset);

        String full_location = eq.getName();
        String[] p = full_location.split("of");
        if (full_location.contains("of")) {

            place.setText(p[1]);
            offset.setText(p[0]+"of");
        }
        else{
            offset.setText("Near of");
            place.setText(p[0]);
        }
